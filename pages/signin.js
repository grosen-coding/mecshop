      ...
      <div className={styles.login}>
        <div className={styles.login__container}>
          <div className={styles.login__header}>
            ...
            <span>
              Join our MEC member community.{" "}
              <Link href="/">Go to MEC Home</Link>
            </span>
          </div>
          <div className={styles.login__form}>
            <h1>Sign in</h1>
            <p>Login to your account for all the member benefits!</p>
            <Formik
              enableReinitialize
              initialValues={{
                login_email,
        ...
        <div className={styles.login__container}>
          <div className={styles.login__form}>
            <h1>Sign up</h1>
            <p>
              Not yet a member? Sign up to get member benefits on all the top
              outdoor gear!
            </p>
            <Formik
              enableReinitialize
